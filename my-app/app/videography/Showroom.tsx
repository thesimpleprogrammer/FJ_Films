...
export default async function Showroom () {
    ...
    return (
        <div className="text-white border-y border-white w-full py-32 px-8 text-center lg:text-left lg:px-40" id="Showroom">
            <h1 className="text-5xl lg:underline underline-offset-8 mb-15 ">Show Room</h1>
