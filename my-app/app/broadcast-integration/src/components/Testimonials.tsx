...
export default function Testimonials() {
  ...
  return (
    <div className="w-full pt-16 pb-24 px-8 lg:px-32 flex flex-col gap-3 bg-[#bef27b] text-[#535353]">
      <div className="font-semibold text-black">TESTIMONIES</div>
      ...
      <div className="">
        <Slider {...settings}>
          {people.map((person, index) => (
            <div
              key={index}
              className="relative flex flex-col w-1/3 py-8 px-10 rounded-md bg-[#141414] text-white text-left"
            >
              ...
              <div className="flex justify-between items-center w-full">
                ...
                <div className="text-center">
                  <h1 className="text-white text-2xl">{person.name}</h1>
