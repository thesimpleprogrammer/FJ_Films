...
export default function Subscribe({ podcastData, userData }: any) {
  ...
  return (
    <div className="px-20 py-24 border-b border-white text-white mt-20">
      <div className="w-[80%] flex flex-col gap-10">
        ...
        <div className="flex flex-row gap-3">
          <button className="flex items-center group border border-white hover:bg-white hover:text-black px-4 py-2 transition-colors duration-300 hover:cursor-pointer">
            Listen on Apple Podcasts
            <svg className="ml-3 fill-white transition-colors duration-300 group-hover:fill-black group-hover:stroke-white w-5 inline-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M447.1 332.7C446.9 296 463.5 268.3 497.1 247.9C478.3 221 449.9 206.2 412.4 203.3C376.9 200.5 338.1 224 323.9 224C308.9 224 274.5 204.3 247.5 204.3C191.7 205.2 132.4 248.8 132.4 337.5C132.4 363.7 137.2 390.8 146.8 418.7C159.6 455.4 205.8 545.4 254 543.9C279.2 543.3 297 526 329.8 526C361.6 526 378.1 543.9 406.2 543.9C454.8 543.2 496.6 461.4 508.8 424.6C443.6 393.9 447.1 334.6 447.1 332.7zM390.5 168.5C417.8 136.1 415.3 106.6 414.5 96C390.4 97.4 362.5 112.4 346.6 130.9C329.1 150.7 318.8 175.2 321 202.8C347.1 204.8 370.9 191.4 390.5 168.5z"/></svg>
          </button>
          <button className="border border-white group hover:bg-white hover:text-black px-4 py-2 transition-colors duration-300 hover:cursor-pointer">
            Listen on Spotify
            <svg
              className="ml-3 fill-white transition-colors duration-300 group-hover:fill-black group-hover:stroke-white w-5 inline-block"
